...
@section('script')
 <main id="mainContent" class="md:ml-64 min-h-screen p-4 md:px-8 transition-all duration-300">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 md:p-8 animate-slide-in h-[80vh] overflow-y-auto">
                ...
                <form id="dashboardForm" class="space-y-5">
                    ...
                    <div>
                        ...
                        <select
                            id="department"
                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm bg-white"
                        >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="4"
                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm resize-vertical"
                        ></textarea>
                    </div>
            ...
            <!-- Preview Section -->
            <div class="bg-white rounded-xl shadow-md p-6 md:p-8 animate-slide-in lg:sticky lg:top-8 lg:self-start h-[80vh] overflow-y-auto">
                <h3 class="text-xl font-bold text-gray-800 mb-6 flex items-center gap-2">
