            ...
            <div class="md:h-[100vh] h-[130vh] relative bg-gradient-to-r from-[#000000] to-[#0B4392] pl-4">
                ...
                <div>
                    <p class="text-white absolute top-[20%] lg:top-[25%] lg:text-6xl md:text-4xl  text-2xl "> <span
                            class="text-[#3367d8] hover:text-[#4c7de7]">We Leverage Industry-leading</span> Software Technologies
                    </p>

                    <p class="text-white absolute top-[45%] md:top-[55%] lg:w-[70%] md:text-xl">We use modern and proven technologies to deliver secure, scalable, and high-quality software solutions tailored to your business goals.</p>
                </div>
